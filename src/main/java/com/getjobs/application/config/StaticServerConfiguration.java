...
public class StaticServerConfiguration {
    ...
    private static final String TOMCAT_PROTOCOL = "org.apache.coyote.http11.Http11Nio2Protocol";

    @Bean
    public WebServerFactoryCustomizer<TomcatServletWebServerFactory> servletContainer() {
        return server -> {
            server.setProtocol(TOMCAT_PROTOCOL);
            ...
            if (hasStaticResources) {
                ...
                Connector connector = new Connector(TOMCAT_PROTOCOL);
