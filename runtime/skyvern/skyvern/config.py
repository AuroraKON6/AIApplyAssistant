...
class Settings(BaseSettings):
    ...
    MIMO_API_BASE: str = "http://127.0.0.1:8002/v1"
    ...
    def get_model_name_to_llm_key(self) -> dict[str, dict[str, str]]:
        ...
        mapping["mimo-v2.5-pro"] = {"llm_key": "MIMO_V2_5_PRO", "label": "MiMo V2.5 Pro"}
        if self.ENABLE_OPENAI_COMPATIBLE and self.OPENAI_COMPATIBLE_MODEL_NAME:
            mapping[self.OPENAI_COMPATIBLE_MODEL_NAME] = {
                "llm_key": self.OPENAI_COMPATIBLE_MODEL_KEY,
                "label": f"Custom: {self.OPENAI_COMPATIBLE_MODEL_NAME}",
            }
